...
class JSONV_PUBLIC extractor_old :
        public extractor
{
public:
    virtual ~extractor_old() noexcept;
    ...
    virtual bool extract(const extraction_context& context, reader& from, void* into) const override;
};
